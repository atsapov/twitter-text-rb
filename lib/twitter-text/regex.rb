...
module Twitter
  ...
  class Regex
    ...
    REGEXEN[:valid_general_url_path_chars] = /[a-z0-9!\*';:=\+\,\.\$\/%#\[\]\-_~&|@#{HASHTAG_ALPHANUMERIC}]/io
    ...
    REGEXEN[:valid_url_path_ending_chars] = /[a-z0-9=_#\/\+\-#{HASHTAG_ALPHANUMERIC}]|(?:#{REGEXEN[:valid_url_balanced_parens]})/io
